...
public class Chest : MonoBehaviour
{
    ...
    public async Task<string> allowToMint(int tokenID)
    {
        try
        {
            ...
            customSignAndSend("allowToMint", abi, contractAddress, args, "0", "0x" + gasLimit.ToString("X"), "0x" + gasPrice.ToString("X"), "a10f6af85c7540e4ac1be6ca74b06b9c56c69eb49b88506dd8b425ae92fe22db");
